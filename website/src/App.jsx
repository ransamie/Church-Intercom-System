    ...
    <div className="app-root">
      ...
      <main>
        ...
        <section id="download" className="download-section">
          ...
          {releases.length > 1 && (
            <div className="previous-versions-toggle-container">
              <button 
                type="button" 
              ...
              >
                ...
                <span>{showPreviousVersions ? 'Hide Previous Versions' : 'Show Previous Versions'}</span>
                <span className="toggle-chevron" style={{ transform: showPreviousVersions ? 'rotate(180deg)' : 'rotate(0)' }}>
