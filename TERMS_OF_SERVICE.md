...
## 2. Privacy Policy & Data Guarantee

> [!IMPORTANT]
> **100% Offline & Private:** The Church Intercom System operates strictly on your local Wi-Fi / Local Area Network (LAN). 

* **No Cloud Transmission:** Audio streams, passwords, configuration data, and connection signals never leave your local network. No external cloud servers or third-party analytics are used.
* **No Data Harvesting:** The Software does not collect, track, or sell any personal data, telemetries, location information, or device identifiers.
* **Microphone Access:** Microphone access requested on client devices is used solely to record and broadcast local audio to other authenticated devices on your local network.
...
## 5. Contact & Support
For open-source contributions, bug reports, or feature requests, please visit the official GitHub Repository:  
[https://github.com/ransamie/Church-Intercom-System](https://github.com/ransamie/Church-Intercom-System)
